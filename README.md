...
Now you can see a new icon in your status bar and your shell script will be running the first time. Click on the icon to manually run the script, add it to your autostart programs, see the log file or to just quit the Script Scheduler.
...
*it you delete the *.conf or the *.desktop file, it will create a new one with just all default settings. If you edit the files, it will always read the settings from the files.